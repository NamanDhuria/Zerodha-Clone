    ...
    return ( 
        <div className="container">
            <div className="row content">
                <h1 className='fs-3 mt-5 mb-4'>Charges explained</h1>
                ...
                <div className="col-6 content">
                    ...
                    <p>For BSDA demat account: Zero charges if the holding value is less than ₹4,00,000. To learn more about BSDA, <a href="https://support.zerodha.com/category/account-opening/offline-account-opening/bsda/articles/how-to-open-a-basic-service-demat-account-at-zerodha" target="_blank" rel="noopener noreferrer">Click here</a></p>
                    <p>For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly (90 days). To learn more about AMC, <a href="https://support.zerodha.com/category/account-opening/charges-at-zerodha/statutory-and-exchange/articles/what-is-the-annual-maintenance-charge" target="_blank" rel="noopener noreferrer">Click here</a></p>
                    ...
                    <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. <a href="https://support.zerodha.com/category/console/ledger/articles/interest-charges" target="_blank" rel="noopener noreferrer">Learn more</a></p>
